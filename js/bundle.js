...
function cards () {
    ...
    class MenuCard {
        constructor (scr, alt, tittle, descr, price, parentSelector, ...classes){
            this.scr = scr;
            this.alt = alt;
            this.tittle = tittle;
            this.descr = descr;
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-04-7');
